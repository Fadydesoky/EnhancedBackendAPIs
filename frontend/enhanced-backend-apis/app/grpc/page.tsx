...
import { getUsers, createUser, updateUser, deleteUser, UserData } from '@/services/grpcApi'
...
export default function GrpcApiPage() {
  ...
  const { data: users, isLoading, isError } = useQuery<UserData[]>(['users'], getUsers)
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold">gRPC API Users</h1>
